...
//
//
/// \file Geant4-models/ATLAS-simplified/src/ActionInitialization.cc
...
void CaloRActionInitialization::Build() const
{
  ...
  SetUserAction(new CaloRTrackingAction);
  SetUserAction(new CaloRSteppingAction(fDetConstruction,eventAction));
}  
